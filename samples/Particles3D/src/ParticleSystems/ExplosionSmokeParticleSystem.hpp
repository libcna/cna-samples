...
{
    /**
     * @brief Custom particle system for creating the smokey part of the explosions.
     */
    ...
    public:
         ...
         */
        ExplosionSmokeParticleSystem(Game& game, Content::ContentManager& content)
         ...
         * @return "Particle3DSample.ExplosionSmokeParticleSystem".
         */
