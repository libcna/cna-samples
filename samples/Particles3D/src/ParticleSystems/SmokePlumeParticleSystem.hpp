...
{
    /**
     * @brief Custom particle system for creating a giant plume of long lasting smoke.
     */
    ...
    public:
         ...
         */
        SmokePlumeParticleSystem(Game& game, Content::ContentManager& content)
         ...
         * @return "Particle3DSample.SmokePlumeParticleSystem".
         */
