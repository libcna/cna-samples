...
namespace CpuSkinningDataTypes
{
    ...
    public:
         ...
         * @return `CpuSkinningDataTypes.AnimationPlayer`.
         */
         ...
         */
        [[nodiscard]] const std::vector<Matrix>& getBoneTransformsProperty() const
        {
         ...
         */
        [[nodiscard]] const std::vector<Matrix>& getWorldTransformsProperty() const
        {
         ...
         */
        [[nodiscard]] const std::vector<Matrix>& getSkinTransformsProperty() const
        {
