...
private:
    ...
    void DrawHud() {
        ...
        spriteBatch.Draw(GetWeaponTexture(*player_),
                         playerHUDPosition_ + Vector2(33.0f, 35.0f),
                         Color::White);
        ...
        spriteBatch.Draw(GetWeaponTexture(*computer_),
                         computerHUDPosition_ + Vector2(33.0f, 35.0f),
                         Color::White);
