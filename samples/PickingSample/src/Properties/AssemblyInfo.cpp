...
namespace
{
    ...
    // window is called "Picking". Read from the upstream project this port follows:
    //   PickingSample_4_0/Picking/Picking (Windows).csproj
    // The remaining attributes in the original file are .NET assembly metadata with no
    // observable effect on the running game.
    const CNA::AssemblyTitleAttributeEXT assemblyTitle{"Picking"};
}
