...
#include "SkinnedModel/SkinnedSphere.hpp"
#include "Primitives3D/SpherePrimitive.hpp"
...
namespace SkinningSample
{
    ...
    private:
        ...
        std::vector<std::shared_ptr<SkinnedModel::SkinnedSphere>> skinnedSpheres;
        std::vector<Microsoft::Xna::Framework::BoundingSphere> boundingSpheres;

        bool showSpheres = false;
        std::unique_ptr<Primitives3D::SpherePrimitive> spherePrimitive;
        ...
        SkinnedModel::SkinningData* skinningData = nullptr;
        ...
        static Microsoft::Xna::Framework::Graphics::RasterizerState Wireframe;

        void HandleInput();
        void UpdateCamera(const Microsoft::Xna::Framework::GameTime& gameTime);
        void UpdateBoundingSpheres();
        void DrawBoundingSpheres(const Microsoft::Xna::Framework::Matrix& view,
                                 const Microsoft::Xna::Framework::Matrix& projection);
        void DrawBaseballBat(const Microsoft::Xna::Framework::Matrix& view,
                             const Microsoft::Xna::Framework::Matrix& projection);
    };
}
