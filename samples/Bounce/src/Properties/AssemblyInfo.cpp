...
namespace
{
    ...
    // window is called "Bounce". Read from the upstream project this port follows:
    //   BounceSample_4_0/Bounce/Bounce/Bounce.csproj
    // The remaining attributes in the original file are .NET assembly metadata with no
    // observable effect on the running game.
    const CNA::AssemblyTitleAttributeEXT assemblyTitle{"Bounce"};
}
