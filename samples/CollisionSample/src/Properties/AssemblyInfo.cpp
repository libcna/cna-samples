...
namespace
{
    ...
    // window is called "Collision". Read from the upstream project this port follows:
    //   CollisionSample_4_0/Collision/Collision (Windows).csproj
    // The remaining attributes in the original file are .NET assembly metadata with no
    // observable effect on the running game.
    const CNA::AssemblyTitleAttributeEXT assemblyTitle{"Collision"};
}
