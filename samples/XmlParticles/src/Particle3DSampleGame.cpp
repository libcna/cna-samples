...
namespace Particle3DSample
{
        ...
        : graphics(this)
    {
        ...
        // Construct our particle system components. Every system is the same class driven by a
        // different settings asset -- that is the whole difference from the Particles3D sample.
        explosionParticles =
            std::make_unique<ParticleSystem>(*this, getContentProperty(), "ExplosionSettings");
        explosionSmokeParticles =
            std::make_unique<ParticleSystem>(*this, getContentProperty(), "ExplosionSmokeSettings");
        projectileTrailParticles =
            std::make_unique<ParticleSystem>(*this, getContentProperty(), "ProjectileTrailSettings");
        smokePlumeParticles =
            std::make_unique<ParticleSystem>(*this, getContentProperty(), "SmokePlumeSettings");
        fireParticles =
            std::make_unique<ParticleSystem>(*this, getContentProperty(), "FireSettings");
