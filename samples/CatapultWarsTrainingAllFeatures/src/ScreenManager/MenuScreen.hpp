...
// MenuScreen.hpp — C++ port of ScreenManager/MenuScreen.cs (XNA 4.0 CatapultWars
...
protected:
    ...
    static constexpr int MenuEntryPadding = 25;
...
inline void MenuEntry::Draw(MenuScreen& screen, bool isSelected, const GameTime& gameTime) {
    ...
    spriteBatch.DrawString(font, text_, position_ + Vector2(4.0f, 4.0f), Color::Black,
