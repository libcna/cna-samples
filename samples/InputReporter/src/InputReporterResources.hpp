...
namespace InputReporter
{
    struct InputReporterResources
    {
        ...
        static constexpr const char* BothVibrationMotors =
            "Supports Left and Right Vibration Motors";
        static constexpr const char* ButtonPressed = "Pressed";
        static constexpr const char* ButtonReleased = "Released";
        static constexpr const char* DeadZoneInstructions =
            "Hold START to Change Dead Zone";
        ...
        static constexpr const char* LeftVibrationMotor =
            "Supports Left Vibration Motor Only";
        ...
        static constexpr const char* RightVibrationMotor =
            "Supports Right Vibration Motor Only";
