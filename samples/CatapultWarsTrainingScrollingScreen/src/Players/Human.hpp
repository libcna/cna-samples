...
public:
    ...
    void DrawDragArrow(float arrowScale) {
        spriteBatch_->Draw(*arrow_, catapultPosition_ * getDrawScaleProperty() +
                           Vector2(0.0f, -40.0f) + getDrawOffsetProperty(), std::nullopt,
                           Color::Blue, 0.0f, Vector2::Zero,
...
private:
    ...
    Vector2 catapultPosition_ = Vector2(200.0f, 332.0f);
};
