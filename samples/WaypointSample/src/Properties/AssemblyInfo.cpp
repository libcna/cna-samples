...
namespace
{
    ...
    // window is called "Waypoints". Read from the upstream project this port follows:
    //   WaypointSample_4_0/Waypoints/Waypoints/Waypoints (Windows).csproj
    // The remaining attributes in the original file are .NET assembly metadata with no
    // observable effect on the running game.
    const CNA::AssemblyTitleAttributeEXT assemblyTitle{"Waypoints"};
}
