...
gate and was pushed at the owner's request. The owner also explicitly authorized
pruning, which removed all three fresh work trees while retaining products and
evidence. Further samples still require explicit push/prune instructions.
