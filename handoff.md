...
Chrome gate. Audit `705c95e` and gallery `c544390` reached origin at the
owner's request. Authorized pruning removed all three reproducible work trees,
retaining exact source, scripts, evidence and canonical products. The next
numbered row for this sequential pass is `SAMPLE-020`.
