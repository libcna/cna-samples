...
browser gate. The gallery and audit are committed locally, but the user has
not requested a push for this sample. Its three new work trees are unpruned.
