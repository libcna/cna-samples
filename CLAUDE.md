...
`../cna` or `../sharp-runtime` before changing either dependency. `rules.md` is the binding
...
sample's own content processors, the frozen diagnostic pair, and how to run CNA's tests
